  ...
  return (
    <div className={`${colorScheme[colorTheme]['bg']} py-4 duration-300`}>
      <div className='container md:flex md:items-center'>
        <Link to="/recipe-directory" className='block text-white text-center font-bold text-2xl md:mr-auto mb-2 md:mb-0'>Cook Ninja</Link>
          ...
          <div className='text-center mb-4 md:mr-4 md:mb-0'>
            <label>
              ...
              <input 
                ...
                type="text"
                ref={inputRef}
                disabled={location.pathname !== '/recipe-directory'}
                onChange={handleSearch}
              />
            </label>
          </div>
          <div className='text-center'>
            <Link to="/recipe-directory/create" className={`${colorScheme[colorTheme]['hoverText']} inline-block border border-white font-medium text-white bg-transparent rounded px-1 py-2 hover:bg-white duration-300`}>Create Recipe</Link>
          </div>
        </div>
      </div>
    </div> 
